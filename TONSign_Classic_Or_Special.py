...
user_dir = (
    os.getlogin()
)  # no its not pulling your login info, this is just how i'm making sure it paths to your log folder correctly. thanks for making sure the code is legit tho :'D
